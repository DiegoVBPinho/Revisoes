...
- 💡 ATRIBUIÇÃO_DE_ENDEREÇO (Pendente)
...
- 💡 CONSTRUTOR (Pendente)
- 💡 DECLARAÇÃO_TIPO_PONTEIRO (*) (Pendente)
- 💡 DELETE_ARRAY (delete[]) (Pendente)
- 💡 DESREFERENCIAÇÃO (*) (Pendente)
- 💡 DESTRUTOR (~) (Pendente)
...
- 💡 LOGICA_DE_CONTROLE (Pendente)
- 💡 LÓGICA_DE_PERMUTAÇÃO (Pendente)
- 💡 MANIPULAÇÃO_DE_CSTRINGS (Pendente)
- 💡 MANIPULAÇÃO_DE_VALOR_VIA_ENDEREÇO (Pendente)
- 💡 NEW_ARRAY ([]) (Pendente)
- 💡 NOTAÇÃO_DE_COLCHETES_EM_PONTEIROS (Pendente)
- 💡 OPERADOR_DELETE (Pendente)
- 💡 OPERADOR_NEW (Pendente)
- 💡 OPERADOR_SIZEOF (Pendente)
- 💡 OPERAÇÕES_MATEMÁTICAS_COM_PONTEIROS (Pendente)
- 💡 OVERFLOW_DE_MEMORIA (Pendente)
- 💡 PASSAGEM_DE_PONTEIRO_COMO_PARAMETRO (Pendente)
- 💡 PONTEIRO_DE_CHAR (Pendente)
- 💡 PONTEIRO_DE_STRING (Pendente)
- 💡 PRECEDÊNCIA_DE_OPERADORES (Pendente)
- 💡 RELACIONAMENTO_ENTRE_CLASSES (Pendente)
- 💡 SINTAXE_-> (Pendente)
- 💡 SUBSTITUIÇÃO_DE_CONTEÚDO (Pendente)
